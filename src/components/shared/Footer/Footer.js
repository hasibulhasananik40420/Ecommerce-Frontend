      ...
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 mt-10">
          ...
          <div className="mt-10 md:mt-10 lg:mt-0">
            ...
            <p className="text-[20px] font-normal mt-4 hover:text-[#0068C8] cursor-pointer duration-200">
              About Us{" "}
            </p>

            <p className="text-[20px] font-normal mt-1 hover:text-[#0068C8] cursor-pointer duration-200">
              News & Blog{" "}
            </p>
            <p className="text-[20px] font-normal mt-1 hover:text-[#0068C8] cursor-pointer duration-200">
              Brands{" "}
        ...
        <div className="md:flex justify-between items-center mt-10">
          <div>
            <p className="md:text-[24px] txt-[20px] font-semibold">
